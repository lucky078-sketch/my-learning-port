    ...
    <section id="about" className="scroll-mt-20 px-4 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl">
        <SectionReveal className="mb-16 text-center">
          ...
          <p className="mt-3 text-muted-foreground">A little about who I am.</p>
        </SectionReveal>
          ...
          <SectionReveal className="flex justify-center">
            <div className="relative">
              ...
              <img
                ...
                height={1024}
                loading="lazy"
                className="h-64 w-64 rounded-full border-4 border-card object-cover shadow-xl sm:h-80 sm:w-80"
              />
            </div>
          </SectionReveal>
